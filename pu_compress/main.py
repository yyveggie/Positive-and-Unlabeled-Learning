...
def main():
    ...
    label_trainset = datasets.CIFAR10(root=opt.label_dir, train=True, download=True, transform=transform['train'])
    label_testset = datasets.CIFAR10(root=opt.label_dir, train=False, download=True, transform=transform['val'])
    labelset_index=[]
