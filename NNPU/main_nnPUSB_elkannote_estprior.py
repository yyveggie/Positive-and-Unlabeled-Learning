...
def experiment():
    ...
    for i in range(ite):
        ...
        model, optimizer, loss_list, acc1, acc2, pre0, rec0, pre1, rec1, pre2, rec2, pre3, rec3, pre4, rec4, pre5, rec5, pre, rec = train_pu(
            x_train, t_train, x_test, t_test, pi, epoch, model, optimizer, batchsize, xp)
